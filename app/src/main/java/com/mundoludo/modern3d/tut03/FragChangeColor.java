...
public class FragChangeColor extends Framework {
    ...
    private void initializeProgram(GL3 gl) {
        ...
        String fragShader = findResource("tut03/calc_color.frag");
        ...
        int fragLoopDurationUnf = gl.glGetUniformLocation(theProgram, "fragLoopDuration");

        gl.glUseProgram(theProgram);
        gl.glUniform1f(loopDurationUnf, 5f);
        gl.glUniform1f(fragLoopDurationUnf, 10f);
